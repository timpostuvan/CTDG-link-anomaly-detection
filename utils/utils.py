...
def create_optimizer(
    model: nn.Module,
    node_feat_projection: EmbeddingWithProjection,
    edge_feat_projection: EmbeddingWithProjection,
    optimizer_name: str,
    learning_rate: float,
    ...
    create optimizer
    :param model: nn.Module
    :param node_feat_projection: EmbeddingWithProjection
    :param edge_feat_projection: EmbeddingWithProjection
    ...
    parameters = (
        ...
        + list(node_feat_projection.parameters())
        + list(edge_feat_projection.parameters())
    )
...
class NegativeEdgeSampler(object):
    ...
    def historical_sample(
        ...
        return negative_src_node_ids.astype(np.long), negative_dst_node_ids.astype(
            np.long
        )
